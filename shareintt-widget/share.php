...
/* 
 ...
 It needs to know database credentials, id of user in DB and unifeed-id
 In particular,
 * Make new entry in ttrss_entries, set (title, link, content) from request, 
   also set updated, published & read. Remember new-id
 * Make new entry in ttrss_user_entries, set (new-id->ref_id, unifeed-id->feed_id, user-id->owner_uid) 
