...
if ($_SESSION["uid"] && validate_session($link)) {
    try{
        $t = mysqli_real_escape_string($link, $_POST['gritttt-title']);
        $url = mysqli_real_escape_string($link, $_POST['gritttt-url']);
        $uid = $url.',imported:'.time();
        $c = mysqli_real_escape_string($link, $_POST['gritttt-comment']);
